...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/dickiagustian13/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@dicki_agustian13",
    icon: Instagram,
    url: "https://www.instagram.com/dicki_agustian13/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@Dicki Agustian",
    icon: Youtube,
    url: "https://www.youtube.com/@dickiagustian9906",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@DickiAgustian13",
    icon: Github,
    url: "https://github.com/DickiAgustian13",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@dicki_agustian13",
    color: "black",
